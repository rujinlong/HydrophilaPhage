...
\item Lytic \emph{Aeromonas hydrophila} phage Hp3 forms a highly distinct, unclassified genus
\item Its 84.7-kb genome carries no resistance or known virulence genes
\item A single phage dose raised 7-day survival from 15\% to 85\% under lethal challenge
\item Hp3 is a promising candidate for aquaculture phage biocontrol
\end{itemize}

% eTOC blurb: Cell Reports limit = 40 words. This is 40.
\section*{In Brief}
Liang et al.\ characterize Hp3, a lytic \emph{Aeromonas hydrophila} phage
that defines a highly distinct, unclassified genus. Free of resistance and
virulence genes, a single dose rescues largemouth bass from lethal
infection, making Hp3 a promising candidate for aquaculture biocontrol.

\section*{Graphical abstract}
\begin{center}
\includegraphics[width=0.70\linewidth,keepaspectratio]{graphical_abstract.png}
\end{center}
...
in a highly distinct, currently unclassified \emph{Caudoviricetes} genus,
...
lytic cycle, remains stable across a broad temperature range and pH 6--9,
and carries an 84.75-kb genome with the hallmarks of a virulent
lifestyle but no antimicrobial-resistance genes and no known
